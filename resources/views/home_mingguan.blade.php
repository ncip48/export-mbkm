...
<head>
    ...
    <title>Export Logbook Mingguan</title>
    <style>
        body {
...
<body>
    <h1>Generate Logbook Mingguan MBKM</h1>
    <form action="{{ route('export-mingguan') }}" method="POST" enctype="multipart/form-data" autocomplete="off">
        @csrf
        ...
        <div class="form-group">
            ...
            <small class="text-danger">Jika lebih dari satu minggu, pisahkan dengan koma. Contoh: 1,2,3,4,5</small>
        </div>
